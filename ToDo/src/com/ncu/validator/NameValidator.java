...
public void update3(){int sno,j=0 ; 


Scanner input = new Scanner(System.in);
System.out.print("Enter the old venue : ");
String STRING_A = input.nextLine();
System.out.print("enter the new venue:");

String STRING_B= input.nextLine();


//1
String originalFilePath = "C:\\Users\\comapq\\eclipse-workspace\\ToDo\\ToDo\\ToDo.txt";
...
try {
    ...
    //7
    String modifiedFileContent = originalFileContent.replace(STRING_A, STRING_B);
